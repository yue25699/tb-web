...
function addToFavorite() {
    var a = "http://49.234.86.111:8092/";
    var b = "假淘宝商城-网购上假淘宝，省钱又放心";
    if (document.all) {
...
<div class="w" id="logo">
    <div>
    	<a href="http://49.234.86.111:8092/">
    		<img src="/images/jt-logo.png" alt="假淘宝商城" width="170" height="60"/>
    	</a> <b></b>
    </div>
</div>
...
<div class="w" id="regist">
    <div class="mt">
        ...
        <span style="text-align: right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="flk13"
                ...
                href="http://49.234.86.111:8092/user/login.html"
            ...
            <div class="form" onselectstart="return false;">
                ...
                <div id="o-password">
                    ...
                    <div class="fl item-ifo">
                        ...
                        <label for="protocol">我已阅读并同意<a href="#" class="blue" id="protocol">《假淘宝用户注册协议》</a></label>
                        <span class="clr"></span>
